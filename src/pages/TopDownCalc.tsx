            ...
            <div className="bg-[var(--card-bg)] border border-[var(--border)] p-6 rounded-2xl">
              ...
              <div className={cn(
                ...
                <div>
                  <h2 className="text-base font-bold tracking-tight text-[var(--text-primary)] flex items-center gap-3">
                    ...
                    Building Assets & Design Scope Mapping
                  </h2>
                  <p className="text-xs text-[var(--text-secondary)] mt-0.5">
                    Assign design scopes (Full Design, Architecture Only, Interior Design Only, or Custom Split Scope with Design Reviews) and active phases per asset
                  </p>
                </div>
              ...
              <SectionContent isCollapsed={collapsedSections.assets}>
                <div className="space-y-6 pt-4">
                          ...
                          assets.map((asset) => {
                            ...
                            return (
                              <tr key={asset.id} className="hover:bg-slate-50/70 transition-all">
                                {/* Fully visible, clear, wide Building Name input */}
                                <td className="px-4 py-3 min-w-[280px]">
                                  <div className="flex flex-col gap-1">
                                    <input
                                      ...
                                      placeholder="e.g. Tower 1 (Vertical - 25 Floors)"
                                      title={asset.name}
                                      className="w-full bg-slate-50/60 hover:bg-slate-100/80 focus:bg-white border border-slate-200 hover:border-slate-300 focus:border-indigo-500 rounded-lg px-3 py-1.5 focus:outline-none text-xs font-semibold text-slate-800 transition-all shadow-xs"
                                    />
                                ...
                                <td className="px-3 py-3 text-center">
                                  <input
                                    ...
                                    className="w-12 bg-slate-50/60 hover:bg-slate-100/80 focus:bg-white text-center border border-slate-200 hover:border-slate-300 focus:border-indigo-500 rounded-lg py-1.5 focus:outline-none text-xs font-mono font-medium text-slate-800 transition-all shadow-xs"
                                  />
                                </td>
                                ...
                                <td className="px-4 py-3 text-right">
                                  <input
                                    ...
                                    className="w-24 bg-slate-50/60 hover:bg-slate-100/80 focus:bg-white text-right border border-slate-200 hover:border-slate-300 focus:border-indigo-500 rounded-lg px-2 py-1.5 focus:outline-none text-xs font-mono font-medium text-slate-800 transition-all shadow-xs"
                                  />
                                </td>
                                ...
                                <td className="px-4 py-3 text-right">
                                  <input
                                    ...
                                    className="w-24 bg-slate-50/60 hover:bg-slate-100/80 focus:bg-white text-right border border-slate-200 hover:border-slate-300 focus:border-indigo-500 rounded-lg px-2 py-1.5 focus:outline-none text-xs font-mono font-bold text-emerald-600 transition-all shadow-xs"
                                  />
                                </td>
                  ...
                  {/* Clean trigger to add new asset row */}
                  <button
                    type="button"
